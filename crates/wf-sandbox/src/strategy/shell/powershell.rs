...
pub const DANGEROUS_PATTERNS: &[CommandRule] = &[
    CommandRule {
        id: "core.powershell:iex-download",
        pack: "core.scripting",
        pattern: r"IEX\s*\(?\s*(New-Object|Invoke-WebRequest|Invoke-RestMethod)",
        severity: Severity::Critical,
    },
    CommandRule {
        id: "core.powershell:iex-download",
        pack: "core.scripting",
        pattern: r"Invoke-Expression\s*\(?\s*(New-Object|Invoke-WebRequest)",
        severity: Severity::Critical,
    },
    CommandRule {
        id: "core.powershell:encoded-command",
        pack: "core.scripting",
        pattern: r"-EncodedCommand\s+",
        severity: Severity::Critical,
    },
    CommandRule {
        id: "core.powershell:short-encoded",
        pack: "core.scripting",
        pattern: r"-e\s+[A-Za-z0-9+/=]{20,}",
        severity: Severity::High,
    },
    CommandRule {
        id: "core.powershell:from-base64",
        pack: "core.scripting",
        pattern: r"\[System\.Convert\]::FromBase64String",
        severity: Severity::High,
    },
    CommandRule {
        id: "core.powershell:webclient",
        pack: "core.network",
        pattern: r"New-Object\s+Net\.WebClient",
        severity: Severity::High,
    },
    CommandRule {
        id: "core.powershell:webclient",
        pack: "core.network",
        pattern: r"New-Object\s+System\.Net\.WebClient",
        severity: Severity::High,
    },
    CommandRule {
        id: "core.powershell:download-string",
        pack: "core.network",
        pattern: r#"\.DownloadString\(\s*(['"]?)https?://"#,
        severity: Severity::High,
    },
    CommandRule {
        id: "core.powershell:download-file",
        pack: "core.network",
        pattern: r#"\.DownloadFile\(\s*(['"]?)https?://"#,
        severity: Severity::High,
    },
    CommandRule {
        id: "core.powershell:amsi-utils",
        pack: "core.av-evasion",
        pattern: r"AmsiUtils",
        severity: Severity::Critical,
    },
    CommandRule {
        id: "core.powershell:amsi-init",
        pack: "core.av-evasion",
        pattern: r"amsiInitFailed",
        severity: Severity::Critical,
    },
    CommandRule {
        id: "core.powershell:amsi-utils",
        pack: "core.av-evasion",
        pattern: r"System\.Management\.Automation\.AmsiUtils",
        severity: Severity::Critical,
    },
    CommandRule {
        id: "core.powershell:reflection-load",
        pack: "core.av-evasion",
        pattern: r"\[Ref\].*Assembly.*Load.*System\.Management\.Automation",
        severity: Severity::High,
    },
    CommandRule {
        id: "core.powershell:amsi-getfield",
        pack: "core.av-evasion",
        pattern: r#"GetField\s*\(\s*['"]amsi"#,
        severity: Severity::Critical,
    },
    CommandRule {
        id: "core.powershell:amsi-setvalue",
        pack: "core.av-evasion",
        pattern: r"SetValue\s*\(\s*null",
        severity: Severity::Critical,
    },
    CommandRule {
        id: "core.powershell:com-object",
        pack: "core.scripting",
        pattern: r"New-Object\s+-ComObject\s+",
        severity: Severity::Medium,
    },
    CommandRule {
        id: "core.powershell:wscript-shell",
        pack: "core.scripting",
        pattern: r#"CreateObject\s*\(\s*['"]WScript\.Shell"#,
        severity: Severity::High,
    },
    CommandRule {
        id: "core.powershell:open-process-token",
        pack: "core.privilege",
        pattern: r"Advapi32\..*OpenProcessToken",
        severity: Severity::High,
    },
    CommandRule {
        id: "core.powershell:duplicate-token",
        pack: "core.privilege",
        pattern: r"Advapi32\..*DuplicateToken",
        severity: Severity::High,
    },
    CommandRule {
        id: "core.powershell:virtual-alloc",
        pack: "core.memory",
        pattern: r"Kernel32\..*VirtualAlloc",
        severity: Severity::High,
    },
    CommandRule {
        id: "core.powershell:create-thread",
        pack: "core.memory",
        pattern: r"Kernel32\..*CreateThread",
        severity: Severity::High,
    },
    CommandRule {
        id: "core.powershell:create-process",
        pack: "core.process",
        pattern: r"Kernel32\..*CreateProcess",
        severity: Severity::High,
    },
];
