 ...
 *
 * Implements Graph/Thread specific diff calculation based on the generic DeltaCalculator.
 */
 ...
 * Checkpoint Diff Calculator
 *
 * Extends the generic DeltaCalculator with Graph/Thread specific logic.
 */
...
> {
  ...
  /**
   * Calculate delta between two Thread snapshots
   *
  ...
  /**
   * Calculate other state changes specific to Thread
   */
