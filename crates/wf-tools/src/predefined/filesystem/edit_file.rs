...
pub static EDIT_FILE: ToolDefinition = ToolDefinition {
    ...
    parameters: &[
        ToolParameter { name: "path", r#type: "string", required: true, description: "Absolute path to the file to edit", default_json: None, constraints: None },
        ToolParameter { name: "old_string", r#type: "string", required: true, description: "The exact text to search for (must be unique)", default_json: None, constraints: None },
        ToolParameter { name: "new_string", r#type: "string", required: true, description: "The replacement text", default_json: None, constraints: None },
    ],
