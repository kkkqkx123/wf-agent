...
pub mod tool_metrics {
    ...
    pub const GENERAL_INVOKE_COUNT: &str = "tool.general.invoke.count";
    pub const GENERAL_INVOKE_DURATION: &str = "tool.general.invoke.duration";
    pub const DISCOVERY_COUNT: &str = "tool.discovery.count";
    pub const ACTIVATION_COUNT: &str = "tool.activation.count";
}
...
pub mod timeout_metrics {
    ...
    pub const EXPIRATION_COUNT: &str = "timeout.expiration.count";
    pub const DURATION_ACTUAL: &str = "timeout.duration.actual";
    pub const CANCELLATION_COUNT: &str = "timeout.cancellation.count";
    pub const WARNING_COUNT: &str = "timeout.warning.count";
    pub const WARNING_REMAINING_TIME: &str = "timeout.warning.remaining_time";
}
