/**
 * Graph Checkpoint Configuration Parser
 *
 * Implements Graph-specific configuration parsing logic based on the sdk/core/checkpoint generic framework.
 ...
 * Graph Checkpoint Configuration Parser
 *
 * This extension expands the general configuration parser to include Graph-specific configuration levels.
 *
...
export class GraphCheckpointConfigResolver extends CheckpointConfigResolver {
  /**
   * Parse Graph checkpoint configuration
   *
  ...
  /**
   * Evaluate based on the timing of the trigger (Graph scenario)
   */
