...
/// One persisted state record of an execution.
...
///
/// Recording happens through the execution engine, not through the public
/// API surface, so this is intentionally not re-exported from the crate
/// root.
