...
impl ScriptEngine {
    /// Called by the executor to dispatch the final command.
    /// The `execute_command` callback handles the actual process spawning.
...
mod tests {
    ...
    async fn test_execute_with_template() {
        ...
        let script = ScriptDefinition {
            ...
            arguments: Some(vec![super::super::types::ScriptArgument {
                key: "msg".to_string(),
                r#type: Some(super::super::types::ScriptArgumentType::String),
                required: Some(true),
