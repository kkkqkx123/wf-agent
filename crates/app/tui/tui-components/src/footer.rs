...
impl Footer {
    ...
    pub fn keymap_context(&self) -> tui_core::keymap::KeymapContext {
        use tui_core::keymap::KeymapContext;
        match self.view {
...
pub struct StatusIndicatorWidget {
    ...
    motion_mode: tui_style::motion::MotionMode,
...
impl StatusIndicatorWidget {
    ...
    pub fn new() -> Self {
        Self {
            frame: 0,
            motion_mode: tui_style::motion::MotionMode::default(),
            message: None,
            style: Style::default(),
        }
    }
    ...
    pub fn with_motion_mode(mode: tui_style::motion::MotionMode) -> Self {
        Self {
            frame: 0,
            motion_mode: mode,
            message: None,
    ...
    /// Set the motion mode.
    pub fn set_motion_mode(&mut self, mode: tui_style::motion::MotionMode) {
