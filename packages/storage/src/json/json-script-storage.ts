/**
 * JSON File Script Storage Implementation
  ...
  override async list(options?: ScriptListOptions): Promise<string[]> {
    ...
    if (options) {
      ids = ids.filter(id => {
        ...
        if (options.createdAfter !== undefined && (metadata.createdAt === undefined || metadata.createdAt < options.createdAfter)) {
          return false;
        }
        if (options.createdBefore !== undefined && (metadata.createdAt === undefined || metadata.createdAt > options.createdBefore)) {
          return false;
        }

        if (options.updatedAfter !== undefined && (metadata.updatedAt === undefined || metadata.updatedAt < options.updatedAfter)) {
          return false;
        }
        if (options.updatedBefore !== undefined && (metadata.updatedAt === undefined || metadata.updatedAt > options.updatedBefore)) {
          return false;
        }
