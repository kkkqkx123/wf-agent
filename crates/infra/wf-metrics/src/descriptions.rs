...
pub fn metric_description(name: &str) -> Option<&'static str> {
    Some(match name {
        ...
        token_metrics::REQUEST_DURATION => "Token request duration",
        token_metrics::ERROR_COUNT => "Token request error count",
        token_metrics::RETRY_COUNT => "Token request retry count",
        token_metrics::FIRST_BYTE_DURATION => "Token stream first byte duration",
        ...
        retry_metrics::TIMEOUT_ACTUAL_MS => "Retry timeout actual duration",
        retry_metrics::BACKOFF_CALCULATED_DELAY_MS => "Retry backoff calculated delay",
        ...
        checkpoint_metrics::CREATION_COUNT => "Checkpoint creation count",
        checkpoint_metrics::CREATION_DURATION => "Checkpoint creation duration",
        checkpoint_metrics::CREATION_SIZE => "Checkpoint creation size",
        checkpoint_metrics::CREATION_FAILURE_COUNT => "Checkpoint creation failure count",
        checkpoint_metrics::CLEANUP_COUNT => "Checkpoint cleanup count",
        checkpoint_metrics::CLEANUP_FREED_BYTES => "Checkpoint cleanup freed bytes",
        checkpoint_metrics::CLEANUP_DURATION => "Checkpoint cleanup duration",
        checkpoint_metrics::LOAD_COUNT => "Checkpoint load count",
        ...
        http_metrics::REQUEST_COUNT => "HTTP request count",
        http_metrics::REQUEST_DURATION => "HTTP request duration",
        http_metrics::ERROR_COUNT => "HTTP error count",
        _ => return None,
    })
}
