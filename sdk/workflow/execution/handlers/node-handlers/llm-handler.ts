...
async function executeHumanRelayLLMNode(
  ...
  try {
    ...
    const result = await executeHumanRelay(
      ...
      { thread, conversationManager: context.conversationManager } as unknown as ThreadEntity, // Simplify the processing; in reality, the complete ThreadContext should be passed in.
