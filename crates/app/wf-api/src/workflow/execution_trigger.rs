//! Execution-level trigger commands.
//!
...
/// Enable a trigger for subsequent executions.
...
/// Execution history of a trigger within an execution: the
/// `TriggerExecutionStorageMetadata` records fired under `execution_id` for
/// `trigger_name`, newest first.
