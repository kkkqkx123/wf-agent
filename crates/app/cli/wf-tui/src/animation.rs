...
/// injectable [`crate::clock::now_ms`] and every `*_frame` query routes
...
impl AnimationController {
    ...
    pub fn spinner_frame(&self) -> usize {
        self.spinner_frame_at(crate::clock::now_ms())
    }
    ...
    pub fn pulse_frame(&self) -> usize {
        self.pulse_frame_at(crate::clock::now_ms())
    }
    ...
    pub fn bounce_frame(&self) -> usize {
        self.bounce_frame_at(crate::clock::now_ms())
    }
    ...
    pub fn fade_frame(&self) -> usize {
        self.fade_frame_at(crate::clock::now_ms())
    }
    ...
    pub fn spinner_char(&self) -> &'static str {
        self.spinner_char_at(crate::clock::now_ms())
    }
    ...
    pub fn pulse_char(&self) -> &'static str {
        self.pulse_char_at(crate::clock::now_ms())
    }
    ...
    pub fn bounce_char(&self) -> &'static str {
        self.bounce_char_at(crate::clock::now_ms())
    }
    ...
    pub fn fade_opacity(&self) -> f32 {
        self.fade_opacity_at(crate::clock::now_ms())
    }
