//! Definition and handler of the update_todo_list tool.
...
pub static UPDATE_TODO_LIST: ToolDefinition = ToolDefinition {
    ...
    parameters: &[
        ToolParameter { name: "todos", r#type: "string", required: true, description: "Markdown-formatted todo list with [ ], [-], [x] prefixes", default_json: None, constraints: None },
    ],
    tips: None,
    examples: None,
};
