/**
 * Workflow Graph Analysis Tool Functions
...
/**
 * Complete workflow graph analysis
 * @param graph - The graph data to be analyzed
 * @returns The results of the graph analysis
 */
export function analyzeWorkflowGraph(graph: WorkflowGraphStructure): WorkflowGraphAnalysis {
  // Loop Detection
 ...
 */
export function collectForkJoinPairs(graph: WorkflowGraphStructure): ForkJoinValidationResult {
