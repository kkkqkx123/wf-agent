...
pub fn register_builtin_handlers(
    ...
    // Builtin tool handlers (call_agent / execute_workflow /
    // query_workflow_status / cancel_workflow / skill), registered in the
    // same registry as the Stateless/Stateful handlers.
    register_default_builtin_handlers(registry.builtin_handlers());
