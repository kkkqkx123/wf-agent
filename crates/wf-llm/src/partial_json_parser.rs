...
/// Recover a parseable value from an incomplete JSON stream: tokenize the
/// input, strip trailing incomplete tokens, auto-close unclosed containers
/// and re-parse.
///
...
/// Tokenize a (possibly incomplete) JSON string, skipping dangling tokens
/// (unterminated strings, partial literals).
