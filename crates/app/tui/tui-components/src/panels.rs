...
impl tui_core::renderable::Renderable for CommandPalette {
...
impl tui_core::renderable::Renderable for ModelPanel {
    fn render(&self, area: ratatui::layout::Rect, buf: &mut ratatui::buffer::Buffer) {
        let lines = self.render_lines(area.width, area.height);
        render_lines_into(area, buf, &lines);
    }
...
impl tui_core::renderable::Renderable for SkillPanel {
    fn render(&self, area: ratatui::layout::Rect, buf: &mut ratatui::buffer::Buffer) {
        let lines = self.render_lines(area.width, area.height);
        render_lines_into(area, buf, &lines);
    }
...
impl tui_core::renderable::Renderable for WorkflowPanel {
    fn render(&self, area: ratatui::layout::Rect, buf: &mut ratatui::buffer::Buffer) {
        let lines = self.render_lines(area.width, area.height);
        render_lines_into(area, buf, &lines);
    }
...
impl tui_core::renderable::Renderable for MentionPanel {
    fn render(&self, area: ratatui::layout::Rect, buf: &mut ratatui::buffer::Buffer) {
        let lines = self.render_lines(area.width, area.height);
        render_lines_into(area, buf, &lines);
    }
...
impl tui_core::renderable::Renderable for QueuedPanel {
    fn render(&self, area: ratatui::layout::Rect, buf: &mut ratatui::buffer::Buffer) {
        let lines = self.render_lines(area.width, area.height);
        render_lines_into(area, buf, &lines);
    }
