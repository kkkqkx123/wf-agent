...
if (matchType !== "exact") {
  return {
    success: true,
    content:
      `Edited ${file_path} (matched with tolerance: ${matchType})\n` +
...
// Parser
export { parseUnifiedDiff, validatePatchStructure } from "./parser.js";
...
```typescript
import { parseUnifiedDiff, applyChunk, seekSequence, type PatchChunk } from "./utils/index.js";
```
