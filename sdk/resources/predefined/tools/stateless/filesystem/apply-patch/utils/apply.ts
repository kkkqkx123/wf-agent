 ...
 * @throws PatchApplyError if the patch cannot be applied
 */
 ...
 * @throws PatchApplyError if the hunk cannot be processed
 */
 ...
 * @throws PatchApplyError if any hunk cannot be processed
 */
