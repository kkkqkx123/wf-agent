...
use crate::agent_user_interaction::UserInteractionHandler;
...
mod tests {
    ...
    impl crate::agent_user_interaction::UserInteractionHandler for CountingHandler {
        fn on_interaction(&self, _record: &crate::agent_user_interaction::AgentUserInteractionEventRecord) {
