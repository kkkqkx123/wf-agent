...
pub static SKILL: ToolDefinition = ToolDefinition {
    ...
    parameters: &[
        ToolParameter { name: "skill", r#type: "string", required: true, description: "The skill name to load", default_json: None, constraints: None },
        ToolParameter { name: "args", r#type: "object", required: false, description: "Optional key-value pairs passed as template variables to the skill. Substituted into {{name}} placeholders in the skill content.", default_json: None, constraints: None },
    ],
    tips: None,
