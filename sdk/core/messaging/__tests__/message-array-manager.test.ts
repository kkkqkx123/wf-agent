...
describe("MessageArrayManager", () => {
  ...
  describe("execute - INSERT", () => {
    it("should insert messages at position 0", () => {
      manager = new MessageArrayManager([{ role: "user", content: "World" }]);
      const result = manager.execute({
        operation: "INSERT",
        messages: [{ role: "user", content: "Hello" }],
        position: 0,
    ...
    it("should insert messages at the end", () => {
      manager = new MessageArrayManager([{ role: "user", content: "Hello" }]);
      const result = manager.execute({
        operation: "INSERT",
  ...
  describe("execute - REPLACE", () => {
    it("should replace message at valid index", () => {
      manager = new MessageArrayManager([{ role: "user", content: "Original" }]);
      const result = manager.execute({
        operation: "REPLACE",
    ...
    it("should create a new batch on replace", () => {
      manager = new MessageArrayManager([{ role: "user", content: "A" }]);
      manager.execute({
        operation: "REPLACE",
  ...
  describe("execute - ROLLBACK", () => {
    it("should rollback to initial state (batch 0)", () => {
      manager = new MessageArrayManager([{ role: "user", content: "Initial" }]);
      manager.execute({
        operation: "INSERT",
  ...
  describe("getCurrentMessages", () => {
    it("should return a copy of current messages", () => {
      manager = new MessageArrayManager([{ role: "user", content: "Test" }]);
