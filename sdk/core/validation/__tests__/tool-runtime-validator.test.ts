...
describe('RuntimeValidator', () => {
  ...
  describe('validate', () => {
    it('should pass validation with valid parameters', () => {
      ...
      expect(() =>
        validator.validate(tool, { name: 'Alice', age: 30 }),
      ).not.toThrow();
    });
    ...
    it('should throw for extra parameter when strict mode', () => {
      const tool = createTool();
      expect(() =>
        validator.validate(tool, { name: 'Alice', extra: 'value' }),
    ...
    it('should throw for wrong type (string instead of number)', () => {
      const tool = createTool();
      expect(() =>
        validator.validate(tool, { name: 'Alice', age: 'thirty' }),
      ).toThrow(RuntimeValidationError);
    });
    ...
    it('should throw for non-integer when integer type expected', () => {
      const tool = createTool();
      expect(() =>
        validator.validate(tool, { name: 'Alice', age: 30.5 }),
      ).toThrow(RuntimeValidationError);
    });
    ...
    it('should handle array parameter type', () => {
      ...
      expect(() =>
        validator.validate(tool, { tags: ['a', 'b', 'c'] }),
      ).not.toThrow();
    });
    ...
    it('should reject non-array for array type', () => {
      ...
      expect(() => validator.validate(tool, { tags: 'not-array' })).toThrow(
    ...
    it('should validate string enum constraint', () => {
      ...
      expect(() => validator.validate(tool, { color: 'yellow' })).toThrow(
        RuntimeValidationError,
      );
    });
    ...
    it('should validate string minLength', () => {
      ...
      expect(() => validator.validate(tool, { code: 'ab' })).toThrow(
        RuntimeValidationError,
      );
    });
    ...
    it('should validate string maxLength', () => {
      ...
      expect(() => validator.validate(tool, { code: '123456' })).toThrow(
        RuntimeValidationError,
      );
    });
    ...
    it('should validate string pattern', () => {
      ...
      expect(() =>
        validator.validate(tool, { email: 'test@example.com' }),
      ).not.toThrow();
      expect(() =>
    ...
    it('should validate number minimum', () => {
      ...
      expect(() => validator.validate(tool, { value: 5 })).toThrow(
        RuntimeValidationError,
      );
    });
    ...
    it('should validate number maximum', () => {
      ...
      expect(() => validator.validate(tool, { value: 101 })).toThrow(
        RuntimeValidationError,
      );
    });
    ...
    it('should validate boolean type', () => {
      ...
      expect(() => validator.validate(tool, { flag: 'yes' })).toThrow(
        RuntimeValidationError,
      );
    });
    ...
    it('should handle nested object parameters', () => {
      ...
      expect(() =>
        validator.validate(tool, { address: { zip: '10001' } }),
      ).toThrow(RuntimeValidationError);
    });
    ...
    it('should handle unknown property type with z.any()', () => {
      ...
      expect(() =>
        validator.validate(tool, { data: { anything: 'goes' } }),
      ).not.toThrow();
    });
    ...
    it('should validate url format', () => {
      ...
      expect(() =>
        validator.validate(tool, { website: 'https://example.com' }),
      ).not.toThrow();
      expect(() =>
        validator.validate(tool, { website: 'not-a-url' }),
      ).toThrow(RuntimeValidationError);
    });
    ...
    it('should validate email format', () => {
      ...
      expect(() =>
        validator.validate(tool, { email: 'not-an-email' }),
      ).toThrow(RuntimeValidationError);
    });
    ...
    it('should validate uuid format', () => {
      ...
      expect(() =>
        validator.validate(tool, { id: 'not-a-uuid' }),
      ).toThrow(RuntimeValidationError);
    });
    ...
    it('should validate date-time format', () => {
      ...
      expect(() =>
        validator.validate(tool, { timestamp: '2024-01-15T10:30:00Z' }),
      ).not.toThrow();
    });
    ...
    it('should validate date format', () => {
      ...
      expect(() =>
        validator.validate(tool, { date: '2024-01-15' }),
      ).not.toThrow();
    });
    ...
    it('should validate time format', () => {
      ...
      expect(() =>
        validator.validate(tool, { time: '10:30:00' }),
      ).not.toThrow();
    });
    ...
    it('should validate ipv4 format', () => {
      ...
      expect(() =>
        validator.validate(tool, { ip: '192.168.1.1' }),
      ).not.toThrow();
      expect(() =>
        validator.validate(tool, { ip: '999.999.999.999' }),
      ).toThrow(RuntimeValidationError);
    });
    ...
    it('should accept unknown format as any string', () => {
      ...
      expect(() =>
        validator.validate(tool, { custom: 'anything' }),
      ).not.toThrow();
    });
  });
});