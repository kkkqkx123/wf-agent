...
pub static EXECUTE_COMMAND: ToolDefinition = ToolDefinition {
    ...
    parameters: &[
        ToolParameter { name: "command", r#type: "string", required: true, description: "The shell command to execute", default_json: None, constraints: None },
        ToolParameter { name: "timeout", r#type: "number", required: false, description: "Timeout in milliseconds", default_json: Some("120000"), constraints: None },
        ToolParameter { name: "cwd", r#type: "string", required: false, description: "Working directory for the command", default_json: None, constraints: None },
        ToolParameter { name: "input", r#type: "string", required: false, description: "Input written once to stdin after start (a trailing newline is appended, then stdin is closed)", default_json: None, constraints: None },
    ],
