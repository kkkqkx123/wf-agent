      ...
      const graph = createGraph([
        ...
        { 
          ...
          config: {
            subgraphId: 'subworkflow-1',
            variableInputs: [
              { externalName: 'input1', internalName: 'var1', required: true, defaultValue: 'default' }
            ]
          }
        },
        { id: 'end', type: 'END' },
      ...
      const graph = createGraph([
        ...
        { 
          ...
          config: {
            subgraphId: 'subworkflow-1',
            variableOutputs: [
              { internalName: 'var1', externalName: 'output1' }
            ]
          }
        },
        { id: 'end', type: 'END' },
      ...
      const graph = createGraph([
        ...
        { 
          ...
          config: {
            subgraphId: 'subworkflow-1',
            variableInputs: [
              { externalName: 'input1', internalName: 'var1' }
            ],
            variableOutputs: [
              { internalName: 'var1', externalName: 'output1' }
            ]
      ...
      const graph = createGraph([
        ...
        { 
          ...
          config: {
            subgraphId: 'subworkflow-1',
            variableInputs: [
              { externalName: '', internalName: 'var1' }
            ]
          }
        },
        { id: 'end', type: 'END' },
      ...
      const graph = createGraph([
        ...
        { 
          ...
          config: {
            subgraphId: 'subworkflow-1',
            variableInputs: [
              { externalName: 'input1', internalName: '' }
            ]
          }
        },
        { id: 'end', type: 'END' },
      ...
      const graph = createGraph([
        ...
        { 
          ...
          config: {
            subgraphId: 'subworkflow-1',
            variableOutputs: [
              { internalName: '', externalName: 'output1' }
            ]
          }
        },
        { id: 'end', type: 'END' },
      ...
      const graph = createGraph([
        ...
        { 
          ...
          config: {
            subgraphId: 'subworkflow-1',
            variableOutputs: [
              { internalName: 'var1', externalName: '' }
            ]
          }
        },
        { id: 'end', type: 'END' },
