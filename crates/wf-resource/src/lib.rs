...
pub use registry::{
    ...
    list_templates_by_category, register_all, register_fragment,
    register_item_skip, register_item_strict, register_template,
    templates_depending_on_fragment, unregister_fragment_checked, unregister_predefined_content,
    unregister_template, RegisterOptions, ResourceRegistries, ResourcePluginActivation,
};
pub use result::Summary;
pub use resource_plugin::{
    ResourceBundle, ResourcePluginRegistry, ResourcePlugin, ResourcePluginConfigField, ResourcePluginConfigFieldType, ResourcePluginMetadata,
};
pub use template::{
