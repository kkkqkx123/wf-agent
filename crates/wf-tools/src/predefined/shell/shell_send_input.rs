...
pub static SHELL_SEND_INPUT: ToolDefinition = ToolDefinition {
    ...
    parameters: &[
        ...
        ToolParameter { name: "input", r#type: "string", required: true, description: "The input to send to the session", default_json: None, constraints: None },
        ToolParameter { name: "enter", r#type: "boolean", required: false, description: "Append a trailing newline (default true)", default_json: Some("true"), constraints: None },
    ],
    tips: None,
