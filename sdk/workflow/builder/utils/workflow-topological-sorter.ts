/**
 * Workflow Graph Topological Sort Tool Function
 ...
 */
export function topologicalSort(graph: WorkflowGraphStructure): TopologicalSortResult {
 ...
 */
function findCycleNodes(graph: WorkflowGraphStructure): ID[] {
