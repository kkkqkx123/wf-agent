...
/// Persisted trigger template definition (TS `TriggerTemplateRegistryAPI`
/// counterpart). A trigger template is a reusable trigger definition that
/// agent loops reference by name.
