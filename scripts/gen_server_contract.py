...
def main():
    ...
    doc = {
        ...
        "shapes": {
            ...
            "SseSince": "opaque hex token same as WS cursor",
        },
        "notes": [
            "List endpoints return the paged shape above; retained bare arrays are bounded in-memory catalogs (providers, models, profile templates, skills, static enums), single-object graph views, or single-parent bounded sets (scopes, node variables, tool dependencies, sessions).",
            "Export endpoints support ?download=true attachment mode (query export plus workflow, template, variable, audit report); batch export-all, profile export and export-all, and metrics export stay envelope-only by design.",
