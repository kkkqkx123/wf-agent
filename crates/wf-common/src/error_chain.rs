...
impl ErrorChainManager {
    ...
    pub fn record_with_metadata(
        ...
        let mut records = crate::lock::lock_ok(self.records.lock());
    ...
    pub fn clear(&self, execution_id: &str) {
        crate::lock::lock_ok(self.records.lock()).remove(execution_id);
    }

    pub fn clear_all(&self) {
        crate::lock::lock_ok(self.records.lock()).clear();
    }
