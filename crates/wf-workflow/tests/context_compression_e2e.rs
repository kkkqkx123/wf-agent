...
fn compression_template(triggered_workflow_id: &str) -> TriggerTemplate {
    TriggerTemplate {
        name: "ctx".to_string(),
        description: None,
...
/// (START_FROM_TRIGGER → LLM → CONTINUE_FROM_TRIGGER) over the input
    ...
    async fn run(
        ...
        let nodes = vec![
            WorkflowNode {
                ...
                node_type: "START_FROM_TRIGGER".to_string(),
            ...
            WorkflowNode {
                ...
                node_type: "CONTINUE_FROM_TRIGGER".to_string(),
                inner: serde_json::json!({
