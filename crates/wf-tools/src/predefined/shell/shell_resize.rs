...
pub static SHELL_RESIZE: ToolDefinition = ToolDefinition {
    ...
    parameters: &[
        ...
        ToolParameter { name: "rows", r#type: "integer", required: true, description: "Number of terminal rows", default_json: None },
        ToolParameter { name: "cols", r#type: "integer", required: true, description: "Number of terminal columns", default_json: None },
    ],
    tips: None,
