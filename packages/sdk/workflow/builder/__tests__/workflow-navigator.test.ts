        ...
        edges: [
          {
            ...
            targetNodeId: "node-a",
            type: "CONDITIONAL",
            condition: { field: "x", operator: "eq", value: 1 } as any,
          },
          { id: "e2", sourceNodeId: "start", targetNodeId: "node-b", type: "DEFAULT" },
        ],
      };
      ...
      const workflow: WorkflowTemplate = {
        ...
        edges: [
          ...
          },
          {
            ...
            targetNodeId: "node-b",
            type: "CONDITIONAL",
            condition: { field: "y", operator: "eq", value: 2 } as any,
            weight: 5,
          },
        ],
      };
  ...
  describe("getPathTo", () => {
    ...
    it("should return null when path is unreachable", () => {
      const workflow: WorkflowTemplate = {
        ...
        edges: [{ id: "e1", sourceNodeId: "start", targetNodeId: "node-a", type: "DEFAULT" }],
      };
  ...
  describe("isForkNode/isJoinNode/isRouteNode", () => {
    it("should correctly identify FORK node", () => {
      const workflow: WorkflowTemplate = {
        ...
        createdAt: Date.now(),
        updatedAt: Date.now(),
        nodes: [{ id: "fork", type: "FORK", name: "Fork", config: {} as any }],
        edges: [],
      };
    ...
    it("should correctly identify JOIN node", () => {
      const workflow: WorkflowTemplate = {
        ...
        createdAt: Date.now(),
        updatedAt: Date.now(),
        nodes: [{ id: "join", type: "JOIN", name: "Join", config: {} as any }],
        edges: [],
      };
    ...
    it("should correctly identify ROUTE node", () => {
      const workflow: WorkflowTemplate = {
        ...
        createdAt: Date.now(),
        updatedAt: Date.now(),
        nodes: [{ id: "route", type: "ROUTE", name: "Route", config: {} as any }],
        edges: [],
      };
