/**
 * GraphConversationSession - Graph-specific Conversation Session
 * Extends ConversationSession to add Graph-specific features (such as tool visibility, etc.)
 *
 * Core Responsibilities:
 * 1. Manage the message history of threads (inherited from ConversationSession)
 * 2. Token statistics and event triggering (inherited from ConversationSession)
 * 3. Tool-specific message management (unique to Graph)
...
const logger = createContextualLogger({ component: "GraphConversationSession" });
...
/**
 * GraphConversationSession Configuration
 */
export interface GraphConversationSessionConfig extends ConversationSessionConfig {
  /** Tool Services */
...
/**
 * GraphConversationSession class
 * Extends ConversationSession with Graph-specific tool visibility management
 */
export class GraphConversationSession extends ConversationSession {
   ...
   */
  constructor(config: GraphConversationSessionConfig) {
    super(config);
  ...
  // ============================================================
  // Tool Description: Message Management (specific to Graph)
  // ============================================================
   ...
   * Add tool visibility management specific to the diagram.
